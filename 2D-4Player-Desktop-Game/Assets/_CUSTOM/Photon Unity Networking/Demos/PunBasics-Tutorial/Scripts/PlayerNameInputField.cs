...
namespace ExitGames.Demos.DemoAnimator
{
	...
	public class PlayerNameInputField : MonoBehaviour
	{
		...
		void Start () {
			...
			PhotonNetworkManager.playerName =	defaultName;
		}
		...
		{
			// #Important
			PhotonNetworkManager.playerName = value + " "; // force a trailing space string in case value is an empty string, else playerName would not be updated.
