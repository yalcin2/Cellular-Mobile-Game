...
namespace ExitGames.Demos.DemoAnimator
{
	public class Launcher : Photon.PunBehaviour {
		...
		void Awake()
		{
			...
			PhotonNetworkManager.autoJoinLobby = false;
		...
		public override void OnConnectedToMaster()
		{
			...
			Debug.Log("Region:"+PhotonNetworkManager.networkingPeer.CloudRegion);
		...
		public override void OnPhotonRandomJoinFailed(object[] codeAndMsg)
		{
			...
			PhotonNetworkManager.CreateRoom(null, new RoomOptions() { MaxPlayers = this.maxPlayersPerRoom}, null);
		}
