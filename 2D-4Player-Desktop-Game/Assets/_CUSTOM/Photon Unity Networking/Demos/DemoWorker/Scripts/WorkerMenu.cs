...
public class WorkerMenu : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        PhotonNetworkManager.automaticallySyncScene = true;

        // the following line checks if this client was just created (and not yet online). if so, we connect
        if (PhotonNetworkManager.connectionStateDetailed == ClientState.PeerCreated)
        {
        ...
        if (String.IsNullOrEmpty(PhotonNetworkManager.playerName))
        {
            PhotonNetworkManager.playerName = "Guest" + Random.Range(1, 9999);
        }
    ...
    public void OnGUI()
    {
        ...
        {
            PhotonNetworkManager.CreateRoom(this.roomName, new RoomOptions() { MaxPlayers = 10 }, null);
        }
    ...
    public void OnFailedToConnectToPhoton(object parameters)
    {
        ...
        Debug.Log("OnFailedToConnectToPhoton. StatusCode: " + parameters + " ServerAddress: " + PhotonNetworkManager.ServerAddress);
    }
