...
public class ChatGui : MonoBehaviour, IChatClientListener
{
	...
	public void Start()
	{
		...
		bool _AppIdPresent = string.IsNullOrEmpty(PhotonNetworkManager.PhotonServerSettings.ChatAppID);
		this.missingAppIdErrorPanel.SetActive(_AppIdPresent);
		
		this.UserIdFormPanel.gameObject.SetActive(!_AppIdPresent);
		
		if (string.IsNullOrEmpty(PhotonNetworkManager.PhotonServerSettings.ChatAppID))
		{
	...
	public void Connect()
	{
        ...
        #endif
        this.chatClient.Connect(PhotonNetworkManager.PhotonServerSettings.ChatAppID, "1.0", new ExitGames.Client.Photon.Chat.AuthenticationValues(UserName));
