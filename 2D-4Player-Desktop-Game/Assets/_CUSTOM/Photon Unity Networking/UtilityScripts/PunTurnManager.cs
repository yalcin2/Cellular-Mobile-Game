...
public class PunTurnManager : PunBehaviour
{
    ...
    public int Turn
    {
        get { return PhotonNetworkManager.room.GetTurn(); }
        private set {

			_isOverCallProcessed = false;

			PhotonNetworkManager.room.SetTurn(value, true);
		}
    }
	...
	{
		get { return ((float)(PhotonNetworkManager.ServerTimestamp - PhotonNetworkManager.room.GetTurnStart()))/1000.0f; }
	}
    ...
    {
        get { return PhotonNetworkManager.room != null && Turn > 0 && this.finishedPlayers.Count == PhotonNetworkManager.room.PlayerCount; }
    }
    ...
    {
        get { return this.finishedPlayers.Contains(PhotonNetworkManager.player); }
    }
    ...
    void Start()
    {
        PhotonNetworkManager.OnEventCall = OnEvent;
    }
    ...
    public void SendMove(object move, bool finished)
    {
        ...
        PhotonNetworkManager.RaiseEvent(evCode, moveHt, true, new RaiseEventOptions() { CachingOption = EventCaching.AddToRoomCache });
        if (finished)
        {
...
public static class TurnExtensions
{
    ...
    public static void SetTurn(this Room room, int turn, bool setStartTime = false)
    {
        ...
        if (setStartTime)
        {
            turnProps[TurnStartPropKey] = PhotonNetworkManager.ServerTimestamp;
        }
    ...
    {
        Room room = PhotonNetworkManager.room;
        if (room == null || room.CustomProperties == null || !room.CustomProperties.ContainsKey(TurnPropKey))
        {
            return 0;
        }
