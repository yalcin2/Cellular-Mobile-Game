...
public class PickupItem : Photon.MonoBehaviour, IPunObservable
{
    ...
    public void PunPickup(PhotonMessageInfo msgInfo)
    {
        ...
        {
            // optional logging:
            Debug.Log("Ignored PU RPC, cause item is inactive. " + this.gameObject + " SecondsBeforeRespawn: " + SecondsBeforeRespawn + " TimeOfRespawn: " + this.TimeOfRespawn + " respawn in future: " + (TimeOfRespawn > PhotonNetworkManager.time));
        ...
        else
        {
            ...
            double timeSinceRpcCall = (PhotonNetworkManager.time - msgInfo.timestamp);
    ...
    internal void PickedUp(float timeUntilRespawn)
    {
        ...
        if (timeUntilRespawn > 0)
        {
            this.TimeOfRespawn = PhotonNetworkManager.time + timeUntilRespawn;
    ...
    internal void PunRespawn()
    {
        ...
        double timeDiffToRespawnTime = PhotonNetworkManager.time - this.TimeOfRespawn;
