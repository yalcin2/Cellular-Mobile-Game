...
public class NetworkCullingHandler : MonoBehaviour, IPunObservable
{
    ...
    private void Start()
    {
        ...
        if (PhotonNetworkManager.inRoom)
        {
            if (this.cullArea.NumberOfSubdivisions == 0)
            {
                ...
                PhotonNetworkManager.SetInterestGroups(this.cullArea.FIRST_GROUP_ID, true);
            }
            else
            {
    ...
    private void UpdateInterestGroups()
    {
        ...
        PhotonNetworkManager.SetInterestGroups(disable.ToArray(), this.activeCells.ToArray());
    }
