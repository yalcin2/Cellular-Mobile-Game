...
public class Room : RoomInfo
{
    ...
    public new bool IsOpen
    {
        ...
        set
        {
            if (!this.Equals(PhotonNetworkManager.room))
            {
                UnityEngine.Debug.LogWarning("Can't set open when not in that room.");
            }

            if (value != this.openField && !PhotonNetworkManager.offlineMode)
            {
                PhotonNetworkManager.networkingPeer.OpSetPropertiesOfRoom(new Hashtable() { { GamePropertyKey.IsOpen, value } }, expectedProperties: null, webForward: false);
            }
    ...
    public new bool IsVisible
    {
        ...
        set
        {
            ...
            if (value != this.visibleField && !PhotonNetworkManager.offlineMode)
            {
                PhotonNetworkManager.networkingPeer.OpSetPropertiesOfRoom(new Hashtable() { { GamePropertyKey.IsVisible, value } }, expectedProperties: null, webForward: false);
            }
    ...
    public new int MaxPlayers
    {
        ...
        set
        {
            ...
            if (value != this.maxPlayersField && !PhotonNetworkManager.offlineMode)
            {
                PhotonNetworkManager.networkingPeer.OpSetPropertiesOfRoom(new Hashtable() { { GamePropertyKey.MaxPlayers, (byte)value } }, expectedProperties: null, webForward: false);
            }
    ...
    public new int PlayerCount
    {
        get
        {
            if (PhotonNetworkManager.playerList != null)
            {
                return PhotonNetworkManager.playerList.Length;
            }
            else
            {
                return 0;
    ...
    public int PlayerTtl
    {
        ...
        set
        {
            ...
            if (value != this.playerTtlField && !PhotonNetworkManager.offlineMode)
            {
                PhotonNetworkManager.networkingPeer.OpSetPropertyOfRoom(GamePropertyKey.PlayerTtl, value);
            }
    ...
    public int EmptyRoomTtl
    {
        ...
        set
        {
            ...
            if (value != this.emptyRoomTtlField && !PhotonNetworkManager.offlineMode)
            {
                PhotonNetworkManager.networkingPeer.OpSetPropertyOfRoom(GamePropertyKey.EmptyRoomTtl, value);
            }
    ...
    public void SetPropertiesListedInLobby(string[] propsListedInLobby)
    {
        ...
        PhotonNetworkManager.networkingPeer.OpSetPropertiesOfRoom(customProps, expectedProperties: null, webForward: false);
    ...
    public void ClearExpectedUsers()
    {
        ...
        PhotonNetworkManager.networkingPeer.OpSetPropertiesOfRoom(props, expected, webForward: false);
    }
