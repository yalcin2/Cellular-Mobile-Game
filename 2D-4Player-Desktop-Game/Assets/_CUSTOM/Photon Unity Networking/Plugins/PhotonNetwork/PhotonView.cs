...
public class PhotonView : Photon.MonoBehaviour
{
    ...
    public int prefix
    {
        get
        {
            if (this.prefixBackup == -1 && PhotonNetworkManager.networkingPeer != null)
            {
                this.prefixBackup = PhotonNetworkManager.networkingPeer.currentLevelPrefix;
            }
    ...
    public object[] instantiationData
    {
        get
        {
            if (!this.didAwake)
            {
                ...
                this.instantiationDataField = PhotonNetworkManager.networkingPeer.FetchInstantiationData(this.instantiationId);
            }
    ...
    public int viewID
    {
        ...
        set
        {
            ...
            this.ownerId = value / PhotonNetworkManager.MAX_VIEW_IDS;

            this.viewIdField = value;

            if (viewMustRegister)
            {
                PhotonNetworkManager.networkingPeer.RegisterPhotonView(this);
            }
    ...
    {
        get { return this.ownerId != 0 && PhotonNetworkManager.networkingPeer.mActors.ContainsKey(this.ownerId); }
    }

    public int CreatorActorNr
    {
        get { return this.viewIdField / PhotonNetworkManager.MAX_VIEW_IDS; }
    }
    ...
    public bool isMine
    {
        get
        {
            return (this.ownerId == PhotonNetworkManager.player.ID) || (!this.isOwnerActive && PhotonNetworkManager.isMasterClient);
        }
    }
    ...
    {
        PhotonNetworkManager.networkingPeer.RequestOwnership(this.viewID, this.ownerId);
    }
    ...
    {
        PhotonNetworkManager.networkingPeer.TransferOwnership(this.viewID, newOwnerId);
    ...
    protected internal void OnDestroy()
    {
        ...
        {
            bool wasInList = PhotonNetworkManager.networkingPeer.LocalCleanPhotonView(this);
            bool loading = false;
            ...
            if (wasInList && !loading && this.instantiationId > 0 && !PhotonMenuManager.AppQuits && PhotonNetworkManager.logLevel >= PhotonLogLevel.Informational)
            {
    ...
    {
        PhotonNetworkManager.RPC(this, methodName, target, false, parameters);
    }
    ...
    {
        PhotonNetworkManager.RPC(this, methodName, target, encrypt, parameters);
    }
    ...
    {
        PhotonNetworkManager.RPC(this, methodName, targetPlayer, false, parameters);
    }
    ...
    {
        PhotonNetworkManager.RPC(this, methodName, targetPlayer, encrypt, parameters);
    }
    ...
    {
        return PhotonNetworkManager.networkingPeer.GetPhotonView(viewID);
    }
