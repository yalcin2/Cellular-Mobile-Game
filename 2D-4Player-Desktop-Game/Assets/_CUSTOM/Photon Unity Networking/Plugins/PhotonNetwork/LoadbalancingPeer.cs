...
using ExitGames.Client.Photon;
    ...
    internal class LoadBalancingPeer : PhotonPeer
    {
        ...
        public virtual bool OpAuthenticateOnce(string appId, string appVersion, AuthenticationValues authValues, string regionCode, EncryptionMode encryptionMode, ConnectionProtocol expectedProtocol)
        {
            ...
            {
                Debug.LogWarning("Expected protocol set to UDP, due to encryption mode DatagramEncryption. Changing protocol in PhotonServerSettings from: " + PhotonNetworkManager.PhotonServerSettings.Protocol);
                PhotonNetworkManager.PhotonServerSettings.Protocol = ConnectionProtocol.Udp;
    ...
    public class RoomOptions
    {
        ...
        private bool cleanupCacheOnLeaveField = PhotonNetworkManager.autoCleanUpPlayerObjects;
