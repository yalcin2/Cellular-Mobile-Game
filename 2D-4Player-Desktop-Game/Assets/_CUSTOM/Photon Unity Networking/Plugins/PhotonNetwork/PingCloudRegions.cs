...
public class PhotonPingManager
{
    ...
    public IEnumerator PingSocket(Region region)
    {
        ...
        PhotonPing ping;
        if (PhotonMenuManager.PingImplementation == typeof(PingNativeDynamic))
        {
        ...
        else if(PhotonMenuManager.PingImplementation == typeof(PingNativeStatic))
        {
        ...
        else if (PhotonMenuManager.PingImplementation == typeof(PingMono))
        {
        ...
        {
            ping = (PhotonPing)Activator.CreateInstance(PhotonMenuManager.PingImplementation);
        }
        ...
        Debug.Log("Ping Debug - PhotonHandler.PingImplementation: " + PhotonMenuManager.PingImplementation + " ping.GetType():" + ping.GetType() + " regionAddress:" + regionAddress);
