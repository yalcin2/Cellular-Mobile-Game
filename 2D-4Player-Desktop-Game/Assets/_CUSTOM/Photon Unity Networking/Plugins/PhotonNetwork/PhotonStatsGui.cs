...
public class PhotonStatsGui : MonoBehaviour
{
    ...
    public void OnGUI()
    {
        if (PhotonNetworkManager.networkingPeer.TrafficStatsEnabled != statsOn)
        {
            PhotonNetworkManager.networkingPeer.TrafficStatsEnabled = this.statsOn;
        }
    ...
    public void TrafficStatsWindow(int windowID)
    {
        ...
        TrafficStatsGameLevel gls = PhotonNetworkManager.networkingPeer.TrafficStatsGameLevel;
        long elapsedMs = PhotonNetworkManager.networkingPeer.TrafficStatsElapsedMs / 1000;
        if (elapsedMs == 0)
        {
            elapsedMs = 1;
        }
        ...
        if (this.buttonsOn)
        {
            ...
            {
                PhotonNetworkManager.networkingPeer.TrafficStatsReset();
                PhotonNetworkManager.networkingPeer.TrafficStatsEnabled = true;
            }
        ...
        if (this.trafficStatsOn)
        {
            ...
            trafficStatsIn = "Incoming: \n" + PhotonNetworkManager.networkingPeer.TrafficStatsIncoming.ToString();
            trafficStatsOut = "Outgoing: \n" + PhotonNetworkManager.networkingPeer.TrafficStatsOutgoing.ToString();
        ...
        if (this.healthStatsVisible)
        {
            ...
            healthStats = string.Format(
                ...
                PhotonNetworkManager.networkingPeer.RoundTripTime,
                PhotonNetworkManager.networkingPeer.RoundTripTimeVariance,
                PhotonNetworkManager.networkingPeer.ResentReliableCommands);
