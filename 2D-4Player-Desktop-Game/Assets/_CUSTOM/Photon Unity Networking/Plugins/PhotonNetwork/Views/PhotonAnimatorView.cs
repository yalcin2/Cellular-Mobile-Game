...
#pragma warning restore 0414
    ...
    private void Update()
    {
        if (this.m_Animator.applyRootMotion && this.m_PhotonView.isMine == false && PhotonNetworkManager.connected == true)
        {
            this.m_Animator.applyRootMotion = false;
        }

        if (PhotonNetworkManager.inRoom == false || PhotonNetworkManager.room.PlayerCount <= 1)
        {
