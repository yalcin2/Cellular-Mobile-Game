...
public class PlayerController : MonoBehaviour
{
    ...
    bool Valid(Vector2 direction)
    {
        ...
        return hit.collider.name == "coin" || (hit.collider == GetComponent<Collider2D>());
    }
    ...
    {
        if (other.name == "teleportWall1")
        {
            gameObject.transform.position = new Vector2(27f, 17f);
            _dest = new Vector2(27f, 17f);
            GetComponent<Animator>().SetFloat("DirX", 0);
            GetComponent<Animator>().SetFloat("DirY", 1);
        }
        else if (other.name == "teleportWall2")
        {
            gameObject.transform.position = new Vector2(2f, 17f);
            _dest = new Vector2(2f, 17f);
            GetComponent<Animator>().SetFloat("DirX", 1);
            GetComponent<Animator>().SetFloat("DirY", 0);
        }
    }
